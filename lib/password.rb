...
module Authlogic
  module ActsAsAuthentic
    ...
    module Password
      ...
      module Config
        def require_password_field(value = nil)
          rw_config(:require_password_field, value, true)
        end
        alias_method :require_password_field=, :require_password_field
        ...
        module InstanceMethods
          ...
          private
            ...
            def require_password?
              self.class.require_password_field && (new_record? || password_changed? || send(crypted_password_field).blank?)
            end
